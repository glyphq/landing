...
describe("Glyph Connect v4 request initiation", () => {
  test("prewarms a registered relay session and consumes it synchronously for the actionable launch", async () => {
    let prepareCalls = 0;
    ...
    const warming = store.prewarm();
    expect(store.prewarm()).toBe(warming);
