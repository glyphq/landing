...
export type LicenseStatus = "Open source" | "No license published" | "Planned";
...
export const products: Product[] = [
  {
    ...
    status: "Available", licenseStatus: "Open source", licenseName: "MIT", accent: "wallet",
  ...
  { id: "explorer", name: "Glyph Explorer", descriptor: "A focused view of Qubic network activity", summary: "Live Qubic network data for identities, transactions, contracts, tokens, ticks, and the rich list.", status: "Available", licenseStatus: "No license published", licenseName: "Public repository", accent: "explorer", repositoryUrl: "https://github.com/glyphq/explorer", websiteUrl: "https://explorer.glyphq.org", capabilities: ["Network statistics and live Qubic price", "Identity balances and activity", "Transactions, ticks, contracts, and tokens", "Rich list and direct identifier lookup"], principles: ["Trace data to its source", "Make state and uncertainty visible", "Prefer readable relationships over dense dashboards"], related: ["wallet", "connect", "docs"] },
  ...
  { id: "docs", name: "Glyph Docs", descriptor: "Documentation for the Glyph product stack", summary: "Guides and references for integrating with Glyph Wallet, Connect, and Relay.", status: "Available", licenseStatus: "No license published", licenseName: "Public documentation site", accent: "docs", documentationUrl: "https://docs.glyphq.org", capabilities: ["Integration guides", "Protocol references", "Wallet and Relay documentation"], principles: ["Examples must run", "Status belongs beside documentation", "Concepts connect across products"], related: ["connect", "explorer", "devkit"] },
...
export const unavailableProducts = products.filter((product) => product.status !== "Available");
export const productsByAvailability = [...availableProducts, ...unavailableProducts];
