...
export function Header() {
  ...
  return <header ref={header} className="site-header"><div className="header-inner">
    ...
    <nav className="desktop-nav" aria-label="Primary">
      ...
      <Link href="/developers">Developers</Link><a href="https://docs.glyphq.org" target="_blank" rel="noreferrer">Docs<span className="sr-only"> (opens in a new tab)</span></a><Link href="/open-source">Open source</Link><Link href="/support">Support</Link><Link href="/about">About</Link>
    </nav>
