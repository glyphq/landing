...
| Glyph Connect | Available | https://github.com/glyphq/connect | `@glyph-oss/connect` v3.0.0 on npm | MIT, open source |
...
- npm package `@glyph-oss/connect`, version 3.0.0 at audit time.
